  ...
  const [pieces, setPieces] = useState(
    Array.from({ length: TOTAL_PIECES }, (_, i) => {
      ...
      return {
        ...
        x: getStartingPosition(playerIndex).x,
        y: getStartingPosition(playerIndex).y,
        placed: false,
        boardPosition: null,
  ...
  return (
    <div id="jiangi-game-root" className="russian-jiangi-container" onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onMouseLeave={handleMouseUp} onTouchMove={handleTouchMove} onTouchEnd={handleMouseUp} onTouchCancel={handleMouseUp}>
      ...
      <div className="game-description">
        <p>
          Tic-Tac-Toe, with a twist! You can place your larger pieces over your
          opponent's smaller pieces, and even move pieces after they have been placed.
